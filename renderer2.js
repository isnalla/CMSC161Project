...
//uniforms
    ...
    function drawScene(){
        ...
        _1mBox.addOrientation(_1mBox,[20,2,8],0,0);
        _8mBox.addOrientation(_8mBox,[-19,2,22],0,90);
        _9mBox.addOrientation(_9mBox,[21,2,17],0,90);
        _17mBox.addOrientation(_17mBox,[-2,2,8],0,0);
        _20mBox.addOrientation(_20mBox,[1,2,26],0,0);
        //top right 5m x 9m lab lower wall
        _3mBox.addOrientation(_3mBox,[11,2,11],0,90);
        _4mBox.addOrientation(_4mBox,[11,2,22],0,90);
        //middle right 5m x 9m lab lower wall
        _3mBox.addOrientation(_3mBox,[1,2,11],0,90);
        _4mBox.addOrientation(_4mBox,[1,2,22],0,90);
        //lower right 5m x 9m lab lower wall
        _3mBox.addOrientation(_3mBox,[-9,2,23],0,90);
        _4mBox.addOrientation(_4mBox,[-9,2,12],0,90);
        //kitchen corner - left wall
        _3mBox.addOrientation(_3mBox,[-11.5,2,20],0,0);
        //walls on void
        _4m2Box.addOrientation(_4m2Box,[21,2,0],0,90);
        _10mBox.addOrientation(_10mBox,[-19,2,0],0,90);
        _20mBox.addOrientation(_20mBox,[1,2,4],0,0);
        _20mBox.addOrientation(_20mBox,[1,2,-4],0,0);
        //left rooms border walls
        _6mBox.addOrientation(_6mBox,[21,2,-20],0,90);
        _8mBox.addOrientation(_8mBox,[-19,2,-22],0,90);
        _13mBox.addOrientation(_13mBox,[-6,2,-8],0,0);
        _20mBox.addOrientation(_20mBox,[1,2,-26],0,0);
        //board room right walls
        _1mBox.addOrientation(_1mBox,[20,2,-14],0,0);
        _2mBox.addOrientation(_2mBox,[13,2,-14],0,0);
        //top left 5m x 9m lab upper wall
        _3mBox.addOrientation(_3mBox,[11,2,-23],0,90);
        _4mBox(_4mBox,[11,2,-12],0,90);
        //middle left 5m x 9m lab upper wall
        _3mBox(_3mBox,[1,2,-11],0,90);
        _4mBox(_4mBox,[1,2,-22],0,90);
        //lower left 5m x 9m lab upper wall
        _3mBox(_3mBox,[-9,2,-11],0,90);
        _4mBox(_4mBox,[-9,2,-22],0,90);
        //women's comfort room
        _1mBox(_1mBox,[-24,2,16],0,0);
        _3mBox(_3mBox,[-22,2,28],0,0);
        _6mBox(_6mBox,[-25,2,22],0,90);
        //men's comfort room
        _1mBox(_1mBox,[-24,2,-16],0,0);
        _3mBox(_3mBox,[-22,2,-28],0,0);
        _6mBox(_6mBox,[-25,2,-22],0,90);
        //stairs(entrance)
        _2mBox(_2mBox,[-25,2,-10],0,0);
        _8mBox(_8mBox,[-27,2,-2],0,90);
        _8mBox(_8mBox,[-23,2,-2],0,90);
        //stairs(exit)
        _2mBox(_2mBox,[28,2,4],0,0);
        _2mBox(_2mBox,[28,2,-6],0,0);
        _5mBox(_5mBox,[29.5,2,-1],0,90);
